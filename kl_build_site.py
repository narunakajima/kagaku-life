  ...
  <section style="background:var(--white);border-top:1px solid var(--paper-dim);border-bottom:1px solid var(--paper-dim);">
    <div class="section-inner">
      ...
      <p class="reveal reveal-delay-2" style="text-align:center;font-size:clamp(1rem,3vw,1.1rem);line-height:2;color:#4a5866;max-width:640px;margin:0 auto 20px;">
        テクノロジー分野の最新研究論文を、専門知識がなくてもわかりやすく、かつ誠実に解説するチャンネルです。
      ...
      <p class="reveal reveal-delay-2" style="text-align:center;font-size:clamp(.9rem,2.6vw,1rem);line-height:2;color:#5c6b78;max-width:680px;margin:0 auto 48px;">
        家庭の中の家事支援、高齢の親の見守りや介護、歩行や身体機能を助けるロボット、災害時の捜索・救助、
        そして働き方を変えるAIエージェントまで——<strong style="color:var(--teal);font-weight:700;">架空の生活者を主人公にした物語</strong>を通して、
        まだ研究段階の技術が実現したとき、暮らしにどんな変化が訪れるのかを描きます。
