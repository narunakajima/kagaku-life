...
- 【プレプリントの場合、査読済みと同列の必須条件にはしない。代わりに以下で信頼性を判断する】
  - 著者の所属機関（DeepMind / Stanford / MIT / CMU / Berkeley / NUS等の主要大学・研究所、
    Figure AI / 1X / Boston Dynamics等の実績あるロボティクス企業の研究部門、Broad Institute /
    Harvard Medical School / Mayo Clinic等の医学研究機関、Genentech / Moderna等の実績ある
    バイオ企業など、分野を問わず実績ある機関に所属しているか。無名の個人・実績不明の機関のみの
    場合は信頼性を下げて判断する）
